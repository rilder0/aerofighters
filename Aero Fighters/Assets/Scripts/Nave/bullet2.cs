...
public class bullet2 : MonoBehaviour
{
    ...
    public float bullet2velocityX;
    
    private float TimetoDestroyBullet2; //variavel que guarda o tempo pra bala do jogador ser destruída (ela tem alcance limitado)


    void Start()
    {
        this.TimetoDestroyBullet2 = 0; //começa com 0 segundos
        this.Bullet2rigidbody.velocity = new Vector2(bullet2velocityX, 0);
    }

    void Update()
    {
        this.TimetoDestroyBullet2 += Time.deltaTime; //aumenta 1s 
        if(this.TimetoDestroyBullet2 >= 0.5f) { //quando se passar meio segundo, a contagem zera de novo pra um novo ciclo 
            TimetoDestroyBullet2 = 0;           // e o gameobject que esse script tá associado (bullet1) é destruído
